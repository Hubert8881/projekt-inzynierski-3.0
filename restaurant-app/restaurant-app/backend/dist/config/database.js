...
const initDatabase = async () => {
    ...
    `);
        await exports.pool.query(`ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS latitude DOUBLE PRECISION;`);
        await exports.pool.query(`ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS longitude DOUBLE PRECISION;`);
        await exports.pool.query(`
    ...
    `);
        await exports.pool.query(`CREATE INDEX IF NOT EXISTS idx_reservations_date_time ON reservations(reservation_date, reservation_time);`);
        await exports.pool.query(`CREATE INDEX IF NOT EXISTS idx_reservations_restaurant ON reservations(restaurant_id);`);
        await exports.pool.query(`CREATE INDEX IF NOT EXISTS idx_tables_restaurant ON tables(restaurant_id);`);
        await exports.pool.query(`
